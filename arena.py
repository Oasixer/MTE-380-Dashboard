...
class Arena():
    ...
    def render_active(self, screen):
        print(isinstance(self.active, CornerCircle))
...
class CornerCircle(Segment):
    ...
    def generate_desired_heading(self, robot):
        ...
        print(f'CIRCLE angle_of_desired_heading: {angle_of_desired_heading}')
        print(f'CIRCLE robot_angle_error: {robot_angle_error}')
        robot.angle_error = robot_angle_error

        print(f'CIRCLE start_angle:{start_angle}')
        print(f'CIRCLE end_angle: {end_angle}')
...
class Line(Segment):
    ...
    def completed(self, pos):
        if self.horizontal:
            ...
            print(f'completed?:{pos[0]<self.end[0]}')
            return pos[0]<self.end[0]
